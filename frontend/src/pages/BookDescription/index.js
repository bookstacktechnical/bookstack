...
import { GetBookById } from "../../backendapicalls/books";
      ...
      <Row gutter={[16, 16]} align="middle" justify="center">
        ...
        >
          ...
          <div className="flex justify-between">
            ...
            <h1 className="text-md">{bookData?.language}</h1>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            <h1 className="text-md">Catalog By</h1>
            <h1 className="text-md">{bookData?.catalogBy}</h1>
          </div>
        </Col>
      </Row>
    </div>
