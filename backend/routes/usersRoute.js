...
// get all the users (customerCount)
...
router.post("/search-customers", authMiddleware, async (req, res) => {
  try {
    const searchText = req.body.searchText;

    // search for Customers with the given search text in their name
    const searchcustomers = await User.find({
      name: {
        $regex: searchText,
        $options: "i",
      },
